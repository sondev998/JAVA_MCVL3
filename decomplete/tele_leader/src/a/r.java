...
extends g {
    ...
    public void a(Graphics graphics) {
        ...
        graphics.setClip((int)var3_4, n3, this.g, n4);
        int n5 = al.a;
        int n6 = this.m;
        if (this.a(256)) {
            --this.n;
        ...
        n2 = 0;
        while (true) {
            if (n2 >= this.a.size() || (n5 = ((aw)this.a.elementAt(n2)).a(graphics, (int)(var3_4 + 2), n5, this.g, 0, bl2, (int)this.c, n3)) - n3 > n4 || n5 > ac.b) {
                al.b(graphics);
                return;
            }
            if (n2 == this.a.size() - 1 && n5 < this.b && this.a(256)) {
                this.n = this.h;
            }
            ++n2;
        }
    ...
    public int h() {
        int n2 = 0;
        for (int i2 = 0; i2 < this.a.size(); ++i2) {
            int n3 = ((aw)this.a.elementAt(i2)).h();
            n2 = n3 + n2;
        }
        return n2;
    }
