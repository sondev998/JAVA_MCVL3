...
public class au {
    ...
    public void F(av av2) {
        ...
        if (n2 % 2 == 0) {
            if (n3 == 21 || n3 == 22 || n3 == 1) {
                ...
                q q2 = (q)av2.a(n2 + 1);
                for (n5 = 66004; n5 <= av2.j / 100; n5 += 2) {
                    object = (ar)av.a(av2, n5, 0);
                    if (object != null && bl2) {
                        ((ar)object).a("+");
                    }
                    av2.c(n5 + 1);
    ...
    public void G(av g2) {
        ...
        if (((String)object).equals(s.b[9])) {
            ...
            n n4 = (n)((av)object).a(21006);
            object = al.a(null, n4.a());
            this.a.a((StringBuffer)object, ((ar)g2).a(), ((ar)g2).e);
            n4.a(((StringBuffer)object).toString());
            f.a(66);
            return;
        }
    ...
    public av a(av av2, int n2, int n3, int n4) {
        ...
        if (n3 == 0) {
            ...
            if (n3 != 1) {
                object = new af[]{new an(n4)};
            }
            av2.a(42013, 1314, n2 + 1, n5, (af[])object);
            av2.b(0);
            return av2;
        }
        if (n3 == 1) {
            ...
            object = n3 == 1 ? var7_5 : new af[]{new an(n4)};
            av2.a(42013, 1131, n2 + 1, n6, (af[])object);
            av2.b(0);
            return av2;
        }
        if (n3 != 2) return av2;
    ...
    public void a(av g2, z object) {
        ...
        for (object2 = 0; object2 < n3; ++object2) {
            n2 = ((z)object).a(object2 * 3 + 2);
            ((ar)((q)g2).a(nArray[n2 * 2 - 2])).a(((z)object).a(object2 * 3 + 2 + 1));
            if (n2 == 8) continue;
            ((ar)((q)g2).a(nArray[n2 * 2 - 1])).a(((z)object).a(object2 * 3 + 2 + 2));
        }
        object = (ar)av2.a(1);
    ...
    public void b(av object, int n2) {
        ...
        if (((av)object).a.a() == 12) {
            ...
            object2 = (ar)av.a((av)object, n3, 1001);
        } else {
            object2 = null;
        }
        ...
        if (n2 == ((av)object).a + 4) {
            object3 = (ar)av.a((av)object, n3, 1000);
            object2 = z.a();
            short s2 = ((q)((av)object).a).i() > 5 ? (short)9 : 7;
            ((z)object2).a(1107, (af)new ba(s2), new j(((ar)object3).a()));
            ((av)object).b(0);
            return;
        }
        if (n2 == 1789450000) {
    ...
    public av c(av av2, int n2, int n3) {
        ...
        for (int i2 = av2.j / 100; i2 >= 66004; --i2) {
            ...
            short[] sArray = q.a;
            int n4 = i2 % 2 == 1 ? 0 : 1;
            q2.c((int)sArray[n4], true);
        }
        Object var6_7 = null;
        av2.b(0).a(n2);
        av2.b(1).a(n3);
        if (n2 == 10) {
            af[] afArray = new af[]{new an(ap.o)};
            av2.e(66003);
            av2.b(66018);
            av2.b(66019);
            av2.f(66003);
        ...
        av2.a(0, n3, n2, (av2.j / 100 - 66004 + 1) / 2, (af[])var6_9);
        av2.b(0);
        return av2;
    }
    ...
    public void c(av av2) {
        ...
        if (n2 == 104010) {
            ...
            ac.a(true, false);
            q q2 = (q)av2.a(104012);
            z.a().a(1500, new ba(14), new an(av.a((av)av2, (int)104007, (int)1000).d), new an(g2.d), new an(g2.b), new ba((short)g2.c), new an(ap.o), new an(Integer.parseInt(q2.a(1).a())), new an(Integer.parseInt(q2.a(4).a())));
            return;
        }
        if (n2 != 104012) return;
    ...
    public void t(av object) {
        ...
        Object object2 = av.a((av)object, ((av)object).f(), 1001);
        if (g2 == null) {
            if (object2 == null) return;
        }
        if (string.equals(s.a[2])) {
        ...
        if (string.equals(s.b[65].substring(0, 2))) {
            z.a().a(1314, new ba(6), new an(g2.d), ((av)object).a(1004), ((av)object).a(1002), ((av)object).a(1001));
            return;
        }
        if (string.equals(s.b[109])) {
            z.a().a(1606, new ba(3), new an(g2.d), new an(g2.e), ((av)object).a(1002), ((av)object).a(1001));
            ac.a(true, false);
            return;
        }
        if (string.equals(s.b[108])) {
            this.a((av)null, 3, g2.d);
            return;
        }
        if (this.a.a((av)object, ((g)object2).d, ((ar)object2).b, string)) return;
        if (string.equals(s.b[62])) {
            object2 = al.a(null, s.d[158]);
            al.a((StringBuffer)object2, av.a((av)object, 43015, 1001).a());
            al.a((StringBuffer)object2, s.d[285]);
            f.a(((StringBuffer)object2).toString(), "", (int)(((av)object).a + 5), -1, false, (bi)object, null);
            return;
        }
        if (string.equals(s.b[61])) {
            object2 = al.a(null, s.d[157]);
            al.a((StringBuffer)object2, av.a((av)object, 43015, 1001).a());
            al.a((StringBuffer)object2, s.d[286]);
            f.a(((StringBuffer)object2).toString(), "", (int)(((av)object).a + 6), -1, false, (bi)object, null);
            return;
        }
        ...
        if (string.equals(s.d[20]) || string.equals("M\u1edf")) {
            z.a().a(1023, (af)new ba(62), (af)new an(ay.a.a()), new an(av.a((av)object, (int)((av)object).f(), (int)1002).d));
            return;
        }
        if (string.equals(s.b[91])) {
            ad.a().a(null, 5, 15, 0);
            return;
        }
        if (string.equals(s.a[85])) {
            this.a.a(null, 6);
            return;
        }
        if (string.equals(s.d[213])) {
            object = this.a;
            if (!w.a()) return;
            ap.a().a("", s.d[155], (byte)10, (byte)11);
            return;
        }
        if (!string.equals(s.b[63])) return;
        if (!w.a()) {
    ...
    public void x(av av2) {
        ...
        if (g2 != null && g2.d != 0) {
            ...
            if (n4 > 0 && (n2 == 0 || n4 <= n2)) {
                object = new StringBuffer(s.d[190]);
                al.a((StringBuffer)object, (long)n4);
                if (n2 > 0) {
                    al.a((StringBuffer)object, "_");
                    al.a((StringBuffer)object, s.b[101]);
                    al.a((StringBuffer)object, "\uff1a");
                    al.a((StringBuffer)object, (long)n2);
                }
                al.a((StringBuffer)object, "_");
                al.a((StringBuffer)object, s.a[10]);
                if (g2.c > 0) {
                    al.a((StringBuffer)object, (long)g2.c);
                    al.a((StringBuffer)object, "m\u00f3n");
                }
                if (g2.b == 32) {
                    al.a((StringBuffer)object, al.a((long)g2.e, 0));
                }
                al.a((StringBuffer)object, av.a(av2, 70020, 1).a());
                f.a(((StringBuffer)object).toString(), "", (int)(av2.a + 2), -1, false, av2, null);
                return;
            }
            f.a(s.d[192]);
            ...
            block13: {
                ...
                block12: {
                    ...
                    if (((String)object2).equals(s.a[66])) {
                        ...
                        z3.a(1138, (af)object2, (af)object, new an(this.a(n2)));
                        return;
                    }
                ...
                z4.a(1138, (af)object, (af)object2, new an(this.a(n2)));
                return;
            }
            n2 = 2833;
        }
