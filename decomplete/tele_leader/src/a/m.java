...
extends y {
    ...
    public static int a(m m2, m m3) {
        ...
        n2 = Math.abs(m2.d - m3.d);
        int n3 = Math.abs(m2.e - m3.e);
        if (n2 == 0 && n3 == 0) {
            return 0;
        }
        if (n3 <= n2) {
...
lbl17:
                            ...
                            var13_13 = (bg)var4_4.elementAt(var7_6);
                            var12_12 /* !! */  = (af[])((int[])this.a.a(var13_13.d));
                            var11_11 /* !! */  = var9_7;
                            var10_9 /* !! */  = var8_10;
                            if (var12_12 /* !! */  != null) {
                                this.a((int[])var12_12 /* !! */ , var9_7, var8_10);
                                var11_11 /* !! */  = (int)var12_12 /* !! */ [0];
                                var10_9 /* !! */  = (int)var12_12 /* !! */ [1];
                            }
                            if (var5_5) break block9;
                            if (var2_2 != var13_13.f()) break block10;
                            var8_10 = var3_3 + 1;
                            var3_3 = var2_2;
                            var2_2 = var8_10;
lbl40:
                            ...
                            while (var2_2 == 0) {
                                var13_13.a(var11_11 /* !! */ , var10_9 /* !! */ , var1_1);
                                var8_10 = var2_2;
lbl43:
                                // 3 sources
                    ...
                    var13_13.a(var8_10 * (var2_2 + 1 >> 1) * 10 + var11_11 /* !! */ , var2_2 * 5 + var10_9 /* !! */ , var1_1);
                    var8_10 = var2_2;
                    ** GOTO lbl43
                }
                var13_13.a(var11_11 /* !! */ , var10_9 /* !! */ , var1_1);
    ...
    private void d() {
        ...
        if (!this.a(false)) {
            ...
            if ((n3 = this.i()) > 0 && (n2 = this.f()) < this.g()) {
                this.b(0, n3 + n2);
            }
        }
        if (this.j != 1) return;
