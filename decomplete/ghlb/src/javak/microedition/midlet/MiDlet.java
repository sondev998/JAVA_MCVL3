...
ItemCommandListener {
    public static javax.microedition.midlet.MiDlet instance;
    ...
    public MiDlet() {
        ...
        textField.setString("-5:1,49:1,50:1,51:1,52:1,53:1,54:1,55:1,56:1");
        this.tfkey = textField;
        this.tfdur = new TextField("Qu\u00e3ng ngh\u1ec9 (mili gi\u00e2y):", "200", 10, 2);
        ...
        try {
            ...
            textField = this.setkey;
            String string = new String(byArray);
            textField.setString(string.trim());
            inputStream.close();
        }
    ...
    static final void cc$(MiDlet miDlet) {
        try {
            ...
            string = new String(miDlet.b2);
            Class.forName(string2.concat(String.valueOf(string)));
    ...
    public void recoverSetting() {
        try {
            ...
            choiceGroup.setSelectedIndex(Integer.parseInt(string2), true);
            recordStore.closeRecordStore();
            return;
        }
        catch (Exception exception) {
