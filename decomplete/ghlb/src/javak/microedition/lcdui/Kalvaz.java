...
extends Canvas {
    ...
    public static Kalvaz kalvazInstance;
    public boolean auto;
    MiDlet m = MiDlet.m;
    Thread t;
    ...
    protected void keyPressed(int n2) {
        ...
        try {
            ...
            if (this.m.sa.getSelectedIndex() == 1) {
                ...
                bl2 = this.auto;
                object = bl2 ? "B\u1eadt" : "T\u1eaft";
                Alert alert = new Alert(null, String.valueOf(object).concat(" auto"), null, AlertType.INFO);
                display.setCurrent((Displayable)alert);
            }
            KalvazAutoClick kalvazAutoClick = new KalvazAutoClick(this);
