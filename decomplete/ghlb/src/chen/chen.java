...
ItemStateListener {
    ...
    public chen() {
        block14: {
            ...
            var1_1 = RecordStore.openRecordStore((String)"chen_rms_urlmap", (boolean)false);
            if (var1_1.getNumRecords() > 0 && (var3_4 /* !! */  = var1_1.getRecord(1)) != null) {
                var4_7 = new ByteArrayInputStream(var3_4 /* !! */ );
                var2_6 = new DataInputStream(var4_7);
            }
            ** GOTO lbl25
            {
                ...
                try {
                    while (true) {
                        chen.chen.map.put(var2_6.readUTF(), var2_6.readUTF());
                    }
                }
...
lbl25:
        ...
        try {
            var1_1 = RecordStore.openRecordStore((String)"chen_rms_setting", (boolean)false);
            if (var1_1.getNumRecords() > 0) {
                var3_4 /* !! */  = var1_1.getRecord(1);
                if (var3_4 /* !! */  == null) {
                    this.e();
                    var1_1.closeRecordStore();
                    return;
        ...
        }
        {
            super(var3_4 /* !! */ );
            super(var2_6);
            Canvas.menukey = var4_7.readInt();
            Canvas.waittime = var4_7.readInt();
            chen.chen.a = var4_7.readUTF();
            chen.chen.b = var4_7.readUTF();
            var4_7.close();
            if (chen.chen.a.length() <= 0) ** GOTO lbl-1000
            super("M\u1eadt kh\u1ea9u");
            var2_6.append((Item)this.c);
            var2_6.setCommandListener(this);
            var3_4 /* !! */  = (byte[])new Command;
            super("X\u00e1c nh\u1eadn", 4, 12);
            var2_6.addCommand((Command)var3_4 /* !! */ );
            var3_4 /* !! */  = (byte[])new Command;
            super("Tho\u00e1t", 7, 13);
            var2_6.addCommand((Command)var3_4 /* !! */ );
            chen.chen.d.setCurrent((Displayable)var2_6);
lbl59:
            // 3 sources
...
lbl-1000:
    ...
    private void e() {
        ...
        int n2 = 0;
        while ((string = this.getAppProperty(String.valueOf(n2))) != null) {
            a a2 = chen.a.a(string);
            if (a.containsKey(a2.a)) {
                string = new StringBuffer().append(a2.a).append('_').toString();
                int n3 = 1;
                do {
                    StringBuffer stringBuffer = new StringBuffer().append(string);
                    a2.a = stringBuffer.append(++n3).toString();
        ...
        list = a;
        string = new TextField("Ph\u00edm chuy\u1ec3n:", String.valueOf(Canvas.menukey), 10, 2);
        this.b = string;
        list.append((Item)string);
        list = a;
        string = new TextField("Th\u1eddi gian chuy\u1ec3n \u1ee9ng d\u1ee5ng:", String.valueOf(Canvas.waittime), 10, 2);
        this.a = string;
        list.append((Item)string);
        a.append((Item)this.c);
        list = a;
        string = new TextField("\u0110\u01b0\u1eddng d\u1eabn l\u01b0u tr\u1eef:", b, 200, 0);
        this.d = string;
        list.append((Item)string);
