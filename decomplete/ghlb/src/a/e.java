...
extends m {
    ...
    private boolean a(Graphics graphics, int n2, int n3) {
        ...
        int n5 = s.a.stringWidth(string) / 2;
        n4 = s.h;
        int n6 = graphics.getColor();
        al.a(graphics, string, n2 - n5, n3 - n4, this.h);
    ...
    public void a(int n2, int n3) {
        if (this.a != null) {
            int n4 = n3 / 10000;
            n3 = n4 / 10;
            bg.a((bg)this.a, 0, n4 % 10 * 1000 + n3 * 10000000 + n2);
        }
    }
            ...
            block14: {
                block16: {
                    block15: {
                        ...
                        var5_3 = aa.a().b((int)this.e) - aa.a().a((int)this.q, (int)this.r);
                        var4_4 = this.a.g();
                        var7_5 = s.h;
                        var6_6 = this.m();
                        if (this.a) {
...
lbl8:
                            ...
                            while (true) {
                                var7_5 = var5_3 - var4_4 - var7_5 - var2_7;
                                if ((0x800000 & var6_6) != 0) {
                                    al.a(a.e.d, 0, var3_2, this.c(s.h + var7_5) + 60, var1_1);
                                }
                                this.a(var1_1, var3_2, var5_3);
                                if ((0x1000000 & var6_6) == 0) break block13;
...
lbl16:
                                ...
                                while (true) {
                                    this.a(var1_1, var3_2 - 11, var5_3 - var4_4, 20, 4);
                                    if (!this.a()) break block14;
                                    this.a(var1_1, var3_2, var7_5, var5_3);
                                    if (this.c()) {
...
lbl25:
                                    ...
                                    while (true) {
                                        var2_7 = s.a.stringWidth((String)this.a) / 2;
                                        var8_8 = this.l();
                                        if (var8_8 > 1 && a.e.b != null) {
                                            a.e.b.c(var8_8);
                                            a.e.b.a(var2_7 + var3_2 + 2 + 8, var7_5, var1_1);
                                            a.e.b.a(0);
                                        }
...
lbl37:
                                                ...
                                                while (true) {
                                                    ...
                                                    if ((262144 & var6_6) != 0) {
                                                        ay.c.a(var1_1, var3_2 + 12, var5_3 - var4_4 - 2, 0);
                                                    }
                                                    this.b(var1_1, var3_2, var5_3);
                                                    this.a(var1_1, var3_2, var5_3, var4_4);
                                                    return;
                                                }
                                            }
                                            break block16;
                ...
                if ((var6_6 & 128) == 0 || (aa.a().b & 0x8000800) != 0) ** GOTO lbl37
