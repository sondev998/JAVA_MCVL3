            ...
            block19: {
                ...
                while (true) {
                    if (n6 >= ((Image)object3).length || al.a((byte[])object3, n6) == n2) {
                        ...
                        object = ((StringBuffer)object).append(s.c[0]).append("p").toString();
                        object2 = new StringBuffer;
                        object2();
                        object2 = al.a(object2.append((String)object).append(n2).append(s.d[9]).toString());
                        object = object3;
                        if (object2 != null) {
    ...
    private static void a(Graphics graphics, int n2, int n3, int n4, int n5, int n6) {
        ...
        block9: {
            ...
            for (n5 = 0; n5 < n7; ++n5) {
                try {
                    n8 = al.a(a, n2);
                    n9 = a[n2 + 2];
                    bf.a(graphics, a[n8], 0, 0, n9 ^ n6, n3, n4);
                    n2 += 3;
                    continue;
                }
                catch (Exception exception) {}
        ...
        for (n5 = 0; n5 < n7; ++n5) {
            ...
            try {
                Image image = a[n9];
                if ((ag.h & n11) != 0) {
                    n8 = -n8 - image.getHeight();
                }
                n9 = n10;
                if ((ag.g & n11) != 0) {
                    n9 = -n10 - image.getWidth();
                }
                bf.a(graphics, image, 0, 0, n11, n9 + n3, n8 + n4);
                n2 += 7;
                continue;
            }
            catch (Exception exception) {}
            ...
            for (n2 = 0; n2 < n3; ++n2) {
                ...
                if ((ag.c & n4) == 0) {
                    ...
                    for (int i2 = 0; i2 < n6; ++i2, n5 += n4) {
                        n7 = al.a(a, n5);
                        if (n7 < 0 || n7 >= a.length || a[n7] != null) continue;
                        bf.a[n7] = bf.a(n7, false, true, 0, 0, 0);
                    }
                }
