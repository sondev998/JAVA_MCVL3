    ...
    public void b() {
        if (this.a != null) {
            ...
            if (a.size() > 0) {
                ...
                int n2 = 0;
                int n3 = 0;
                while (a.size() > 0 && (byArray = (byte[])a.elementAt(0)).length + n2 < 1000) {
                ...
                if (n2 > 0) {
                    ...
                    this.c((int)b, this.a);
                    this.a(n3, this.a);
                    System.arraycopy(byArray2, 0, this.a, 14, n2);
                    al.a(this.a, 5, n2 + 9, (byte)d);
                    al.a(this.a, n2 + 14, al.a(this.a, 2, n2 + 12));
                    al.a(this.a, n2 + 14 + 4, (short)-21846);
                    d = (byte)(d + 1);
                    this.a(this.a, true);
                }
            } else if ((this.b & 1) != 0) {
