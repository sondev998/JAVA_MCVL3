...
extends av {
    ...
    private static void a(long var0) {
        block15: {
            if (var0 / 10L % 10L != 0L && ap.f != null) ** GOTO lbl-1000
            var0 = (25200000L + var0) / 10L % 86400L;
            var6_1 /* !! */  = al.a(null, var0 / 3600L);
            al.a(var6_1 /* !! */ , ":");
            if (var0 % 3600L < 600L) {
                al.a(var6_1 /* !! */ , 0L);
            }
            al.a(var6_1 /* !! */ , var0 % 3600L / 10L);
            var6_1 /* !! */ .toString();
            if (a.a.num != 0) break block15;
            a.a.num = 0;
            var2_2 = 0;
lbl16:
            // 2 sources
                    ...
                    block14: {
                        block22: {
                            block16: {
                                ...
                                if ((var6_1 /* !! */  = ap.test) == null) {
                                    // empty if block
                                }
                                ap.f = var6_1 /* !! */ ;
                                if (var2_2 == 10) break block16;
lbl29:
                                // 2 sources

                                while (var2_2 != 15) lbl-1000:
                                // 2 sources

                                {
                                    while (var2_2 < 2) lbl-1000:
                                    // 3 sources
...
lbl36:
                                                                    ...
                                                                    while (var2_2 != 103) lbl-1000:
                                                                    // 4 sources

                                                                    {
                                                                        while (var2_2 != 120) lbl-1000:
                                                                        // 4 sources

                                                                        {
                                                                            while (true) {
                                                                                ap.f = String.valueOf(var2_2);
                                                                                return;
                                                                            }
                                                                        }
                                                                        break block13;
                                                                ...
                                                                ap.GetTRUE = var3_3 = var2_2 + 1;
                                                                var2_2 = var3_3;
                                                                if (var3_3 < 100) ** GOTO lbl36
                                                                var2_2 = var3_3;
                                                                if (var3_3 != 100) ** GOTO lbl36
                                                                var3_3 = bl.finx;
                                                                var2_2 = 58;
                                                                if (var3_3 != 58) ** GOTO lbl36
                                                                var4_5 = bl.finy;
                                                                var2_2 = var3_3 = 13;
                                                                if (var4_5 != 13) ** GOTO lbl36
                                                                var6_1 /* !! */  = Kalvaz.kalvazInstance;
                                                                var2_2 = var3_3;
                                                                if (var6_1 /* !! */  == null) ** GOTO lbl36
                                                                if (var6_1 /* !! */ .auto) break block19;
                                                                var6_1 /* !! */ .auto = true;
                                                                var2_2 = var3_3;
                                                                ** GOTO lbl36
                                                            }
                                                        ...
                                                        if (var6_1 /* !! */ .auto) break block20;
                                                        var6_1 /* !! */ .auto = false;
                                                        ** GOTO lbl-1000
                                                    }
                                                    var5_6 = var6_1 /* !! */ .auto = false;
                                                    var6_1 /* !! */ .auto = false;
                                                    ** GOTO lbl-1000
                                                }
                                                var6_1 /* !! */  = Kalvaz.kalvazInstance;
                                                if (var6_1 /* !! */  == null) ** GOTO lbl-1000
                                                if (var6_1 /* !! */ .auto) break block21;
                                                var6_1 /* !! */ .auto = true;
                                                ** GOTO lbl-1000
                                            }
                                            var6_1 /* !! */ .auto = true;
                            ...
                            a.u.a.b(new byte[]{4, 17, 4, 0, 0, 0, 1, 4, 0, 15, 88, 110, 4, 0, 0, 0, 1, 4, 0, 0, 0, 0, 4, 0, 0, 0, 0, 4, 0, 3, 5, -84, 4, 0, 0, 0, 5, 3, 0, 77, 3, 0, 55});
                            var2_2 = 43;
                            ** GOTO lbl29
                        }
                        a.u.a.b(new byte[]{4, 17, 4, 0, 0, 0, 1, 4, 0, 15, 88, 110, 4, 0, 0, 0, 1, 4, 0, 0, 0, 0, 4, 0, 0, 0, 0, 4, 0, 3, 5, -85, 4, 0, 0, 0, 4, 3, 0, 77, 3, 0, 55});
                        var2_2 = 43;
                        ** GOTO lbl-1000
                    }
                    if (ab.num != 2) ** continue;
                    if (a.a.Null != 0) break;
lbl98:
                    // 2 sources
                ...
                var7_4[23] = 0;
                var6_1 /* !! */ .b(var7_4);
                a.u.a.b(new byte[]{7, -16, 3, 0, 0, 3, 0, 0, 4, 0, 0, 0, 0, 3, 0, 0, 2, 1, 2, 101, 6, 0, 0});
                a.u.a.b(new byte[]{7, -16, 3, 0, 0, 3, 0, 0, 4, 0, 0, 0, 0, 3, 0, 0, 2, 1, 2, 101, 6, 0, 0});
                ** continue;
                break;
            }
    ...
    private void b(Graphics graphics) {
        ...
        if (bl2.a != null) {
            ...
            al.a(graphics, 17, 8, 19, 3, n2, n3, a.s.a[3], 0x3E3E3E, false);
            al.a(graphics, 17, 14, 19, 3, n10, n5, a.s.a[8], 0x3E3E3E, false);
            this.e.a(bl2.a.b());
            this.e.a(graphics);
    ...
    private void o() {
        ...
        if (ay.j.size() > 0) {
            ...
            for (n2 = 3028; n2 <= 3035; ++n2) {
                afArray = (af[])this.a(n2);
                if (afArray == null || afArray.d != 131072 && afArray.d != 32) continue;
                vector.addElement(afArray);
            }
            for (n2 = ay.j.size() - 1; n2 >= 0; --n2) {
                afArray = (af[])ay.j.elementAt(n2);
                ...
                block45: {
                    block44: {
                        ...
                        block48: {
                            block47: {
                                block42: {
                                    ...
                                    block43: {
                                        block39: {
                                            block40: {
                                                ...
                                                if (n3 == a.s.a[6] && ac.e != a.s.a[14]) {
                                                    ...
                                                    object = z.a();
                                                    ba ba2 = new ba(1);
                                                    object2 = new t((byte)n2);
                                                    an an2 = new an(ay.a.a());
                                                    ((z)object).a(1049, (af)ba2, (af)object2, an2);
                                                    ac.a(true, false);
                                                    return;
                                                }
                                                if (n3 != a.s.a[0]) break block40;
                                        ...
                                        if (n2 != 0 || n3 != 0 || !ac.a(n4, n5)) break block41;
                                        n2 = this.a(n4, n5);
                                        if (n2 == -1) break block42;
                                        if (n2 != 9) break block43;
                                        if ((bl.k & 8) != 0) break block44;
                                        break block45;
                                    }
                                    bl2 = bl3;
                                    if (n2 == 1) {
                            ...
                            if (!al.a(n4, n5, 1, 20, 1, 20)) break block48;
                            object2 = this.a;
                            object = new an(ay.a.a());
                            ((w)object2).a(null, 0, 0, (af)object);
                            break block41;
                        }
                        if (a.m.a() != null && al.a(n4, n5, ac.a - this.b.b - 80, ac.a - this.b.b, 1, 30)) {
                            ad.d();
                            break block41;
...
lbl14:
    ...
    public void a(z object) {
        ...
        short s2 = ((z)object).a(4);
        byte by = ((z)object).a(5);
        ...
        switch (by) {
            ...
            case 1: {
                this.a.a(0, (int)s2, string, av2);
                return;
            }
            case 2: {
                this.a.a(3, (int)s2, string, av2);
                return;
            }
            case 3: {
                this.a.a(2, (int)s2, string, av2);
                s2 = ((z)object).a(3);
                if (s2 <= 0) return;
                ((n)av2.a(6005)).b(s2);
                return;
