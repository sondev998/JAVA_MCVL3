            ...
            block12: {
                block11: {
                    ...
                    if ((n5 > n4 || n5 == -1) && n4 != -1) {
                        ...
                        n4 = string2.indexOf(")");
                        n5 = string2.indexOf(",");
                        if (n5 > n6 + 2 && n4 > n5 + 2 && aw.a(string2.substring(n6 + 2, n5)) && aw.a(string2.substring(n5 + 1, n4 - 1))) {
                            if (bl2 && string2.charAt(n4 - 1) != 'p') {
        ...
        while (true) {
            ...
            block23: {
                ...
                block24: {
                        ...
                        block25: {
                            block22: {
                                ...
                                if ((n8 > n7 || n8 == -1) && n7 != -1) {
                                    ...
                                    n5 = string2.indexOf(")");
                                    n7 = string2.indexOf(",");
                                    if (n7 > n6 + 2 && n5 > n7 + 2 && aw.a(string2.substring(n6 + 2, n7)) && aw.a(string2.substring(n7 + 1, n5 - 1))) {
                                        byte by;
                                        n8 = string2.charAt(n5 - 1);
                                        long l2 = Long.parseLong(string2.substring(n6 + 2, n7));
                                        long l3 = Long.parseLong(string2.substring(n7 + 1, n5 - 1));
                                        if (n8 == 114) {
                                            by = 12;
                                            n7 = 1;
                                        } else if (n8 == 106) {
                                        ...
                                        for (n6 = 0; n6 < n7; ++n6) {
                                            this.a.addElement(new l(by, n8, l2, (int)l3, by2));
                                        }
                                        string = string2.substring(n5 + 1, string2.length());
                                        continue;
                                    }
                                    this.a.addElement(new l(string2.substring(n6, n6 + 1), 0, "", 0, 0, 0));
                                    string = string2.substring(1, string2.length());
                                    continue;
                                }
                    ...
                    n6 = Integer.parseInt(string2.substring(n5 + 1, n9));
                    this.a.addElement(new l(string2.substring(n4 + 2, n5), n6, string2.substring(n9 + 1, n10), n3, n8, 4));
                    string = string2.substring(n10 + 1, string2.length());
                    n3 = n7;
                    continue;
                }
