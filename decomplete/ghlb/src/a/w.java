...
public class w {
    ...
    public w() {
        ...
        int[] nArray2 = new int[]{6440000, 6370000};
        this.a = new int[][]{nArray, {0x609690, 6380000}, nArray2, {6340000, 6310000}, {6420000, 6460000}, {6350000, 6400000}, {6390000, 6360000}, {6410000, 6430000}};
        int[] nArray3 = new int[]{110000, 210000};
        int[] nArray4 = new int[]{0, 220000};
        int[] nArray5 = new int[]{130000, 0};
        nArray = new int[]{140000, 240000};
        nArray2 = new int[]{150000, 0};
        int[] nArray6 = new int[]{0, 260000};
        int[] nArray7 = new int[]{170000, 270000};
        int[] nArray8 = new int[]{0, 0};
        int[] nArray9 = new int[]{0, 0};
        this.b = new int[][]{nArray3, nArray4, nArray5, nArray, nArray2, nArray6, nArray7, {180000, 280000}, nArray8, nArray9};
    ...
    public static int a(int n2) {
        ...
        block15: {
            ...
            try {
                ...
                as2 = new as(stringBuffer.append(s.c[0]).append("PackageID.o").toString());
                boolean bl2 = as2.a();
        ...
        while (as2 != null) {
            ...
            n3 = n8;
            MyMidlet myMidlet = MyMidlet.m_Midlet;
            n3 = n8;
            n3 = n8;
            stringBuffer = new StringBuffer();
            n3 = n8;
            myMidlet.ConnectAddr = stringBuffer.append("").append(as2.a()).toString();
            n6 = n8;
            n5 = n7;
        }
    ...
    private boolean a(av object) {
        ...
        r2.b(new StringBuffer().append((String)object).append(l3).append("s").toString());
        return false;
    }
    ...
    public void C(av g2) {
        ...
        if (n3 == 57004) {
            ...
            n5 = n4 == 2846 ? 2048 : (n4 == 2878 ? 2048 : 2);
            if (n4 == 2883) {
                n2 = 1;
            }
            this.a.a(n5, (av)g2, 0, new String[]{s.b[9], s.a[2]}, n2);
            return;
        }
        if (n3 == 57006) {
            if (n5 == 3) {
...
lbl54:
    ...
    public void J(av object) {
        ...
        long l3 = l2 / (long)n2;
        ((ar)((av)object).a(1002)).a((int)l3, false);
        object = (d)((av)object).b(4);
        l2 = ((d)object).a;
        ((d)object).a = (long)n2 * l3 + l2;
    }
    ...
    public Vector a() {
        ...
        af[] afArray = ay.a;
        af[] afArray2 = this.a(aa.a().a(afArray.q, (int)afArray.r));
        vector2.addElement(new af[]{new an(afArray.a()), new an(afArray2.d), new an(afArray2.e), new an(-2)});
        int n2 = 0;
        int n3 = 0;
        while (n2 < vector.size()) {
            afArray2 = (af[])vector.elementAt(n2);
            if (afArray2[7].b() == 0) {
                az az2 = this.a(aa.a().a(afArray2[3].b(), afArray2[4].b()));
                afArray = new af[4];
                afArray[0] = new an(afArray2[0].b());
                afArray[1] = new an(az2.d);
                afArray[2] = new an(az2.e);
                if (afArray2[0].b() == 0) {
                    afArray[3] = new an(-1);
                    m.a(++n3, -1, afArray2[3].b(), afArray2[4].b());
                } else {
                    afArray[3] = new an(afArray2[6].b());
                }
                vector2.addElement(afArray);
            }
            ++n2;
        }
        return vector2;
        ...
        if (s2 == s.a[1] || afArray == null && s2 == s.a[6]) {
            if (object3 == null) {
                if (afArray == null) {
                    ...
                    object = new an(s2);
                    s2 = ((m)object2).q;
                    z2.a(1312, (af)object3, t2, (af)object, new an(((m)object2).r + s2 * 1000));
                }
                return false;
            }
            z z3 = z.a();
            ...
            af af2 = afArray[3];
            s2 = ((m)object2).q;
            z3.a(1312, (af)object3, t3, af2, new an(((m)object2).r + s2 * 1000), ((av)object).b(4), new an(ay.a.q * 1000 + ay.a.r));
            return false;
        }
        if (s2 == s.a[6]) {
                ...
                block11: {
                    block9: {
                        block8: {
                            block6: {
                                var4_3 = var1_1.f();
                                var5_4 = var1_1.a(6005).a();
                                var6_5 = (h)var1_1.a(6006);
                                var3_6 = var6_5.f();
...
lbl8:
                                    ...
                                    while (true) {
                                        if (var2_2 > 0) {
                                            z.a().a(2032, new ba(0), new ba(0), new an(0), new ba(0), new t((byte)var2_2), new t(101), new j(var5_4));
                                        }
                                        a.f.a(6);
lbl13:
                                        // 4 sources
...
lbl24:
                    ...
                    var1_1.d(6006);
                    var6_5.a(s.a[4], s.a[4], -1, -1);
                    ** GOTO lbl13
                }
                if (var4_3 == 6010) {
                    var1_1.d(6006);
                    var6_5.a(s.a[5], s.a[5], -1, -1);
                    ** continue;
                }
            }
            var2_2 = 0;
    ...
    public void e(av av2) {
        ...
        if (n2 == 15005) {
            int n3 = ((n)av2.a(15002)).f();
            if (n3 > (n2 = ((n)av2.a(15004)).f()) || n3 <= 0 || n3 >= 121 || n2 <= 0 || n2 >= 121) {
                a.f.a(s.d[374]);
                return;
            } else {
                z.a().a(1023, (af)new ba(50), (af)new an(n3), new an(n2));
            }
            return;
        }
        if (n2 == 15006) {
            ...
            switch (var1_1) {
                ...
                case 20: {
                    ...
                    if (var4_4.b() != 0) {
                        var2_3 = z.a();
                        var3_5 = new ba(4);
                        var2_3.a(1056, (af)var3_5, var4_4);
                    }
                }
lbl36:
                // 11 sources
    ...
    public void k(av av2) {
        ...
        if (n3 == 2021) {
            ...
            n2 = g2.a;
            n3 = g2.b;
            bb.a(n2 + 3, g2.h + n3 + 2, 1, 0, this.a(av2, 1), av2);
            return;
        }
        if (n3 == 2003 || n3 == 2004) {
    ...
    public void w(av object) {
        ...
        object = (t)this.d.elementAt(n2 * 6 + 1);
        object2 = (t)this.d.elementAt(n2 * 6 + 2);
        ...
        bl2.a(n2, ((t)object).b(), ((t)object2).b(), 45);
        if (n3 == 0) return;
        if (!ap.a().d()) return;
        object = ay.a(n3);
