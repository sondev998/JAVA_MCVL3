...
extends g {
     ...
     * Enabled aggressive block sorting
     */
    public static String a(av object, int n2, int n3, String charSequence) {
        ...
        if (charSequence2 != null && !((String)charSequence2).equals("")) {
            String[] stringArray = al.a((String)charSequence2, "_@");
        } else {
            Object var0_7 = null;
        }
        g[] gArray = new g[n10];
        charSequence2 = al.a(null, "");
        n4 = 0;
        for (n5 = 0; n5 < n9; ++n5) {
            n6 = n4;
            if (n5 / n7 != n8) {
                ...
                gArray[n4] = q2.a(n5);
                if (var0_4 != null) {
                    al.a((StringBuffer)charSequence2, (String)var0_4[n5]);
                    al.a((StringBuffer)charSequence2, "_@");
                }
                n6 = n4 + 1;
            }
            n4 = n6;
        ...
        q2.a = gArray;
        CharSequence charSequence3 = charSequence2 = ((StringBuffer)charSequence2).toString();
        if (!((String)charSequence2).endsWith("_@")) return var0_2;
        String string = ((String)charSequence2).substring(0, ((String)charSequence2).length() - 2);
        return var0_2;
    }
