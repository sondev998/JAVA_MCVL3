...
lbl38:
    ...
    public static void a(int n2, Vector vector) {
        int n3;
        Vector vector2 = (Vector)a.a(n2);
        if (vector2 == null) {
            n3 = vector.size() - 1;
        } else {
            for (n2 = vector.size() - 1; n2 >= 0; --n2) {
                af[] afArray = (af[])vector.elementAt(n2);
                if (afArray[1].b() / 10 % 1000 == 39) {
                    vector2.insertElementAt(afArray, 0);
                    continue;
                }
        ...
        while (true) {
            block8: {
                block7: {
                    ...
                    af[] afArray = (af[])vector.elementAt(n3);
    ...
    public static void a(boolean bl2, byte[] object) {
        ...
        try {
            ...
            if (bl2) {
                ...
                z z2 = z.a();
                t t2 = new t(6);
                ba ba2 = new ba(((DataInputStream)object).readShort());
                z2.a(1311, (af)t2, ba2);
            } else {
                ((DataInputStream)object).readShort();
            }
            b.a();
            int n3 = ((DataInputStream)object).readShort();
            while (n2 < n3) {
                b.a(((DataInputStream)object).readInt(), new int[]{((DataInputStream)object).readInt(), ((DataInputStream)object).readInt(), ((DataInputStream)object).readInt()});
                ++n2;
            }
        }
     ...
     * Enabled aggressive block sorting
     */
    public static void a(af[] object) {
        int n2;
        int n3;
        Object object2;
        int n4 = object[3].b();
        ...
        boolean bl2 = false;
        Object object3 = b;
        int n7 = n5 == 2 ? object[4].b() / 1000 : n6 / 1000;
        if ((object3 = (Object)((int[])((p)object3).a(n7))) != null) {
            object2 = object3[0];
        ...
        int n9 = object[2].b();
        n7 = (short)(n4 / 100000);
        object3 = ay.a(n8, al.d(n4 / 10 % 100));
        ...
        if (n5 == 3 || n8 != ay.a.a()) {
            ...
            af[] afArray = ((m)object3).a(5);
            for (n8 = 0; n8 < 2; ++n8) {
                void var0_2;
                n3 = n7;
                if (var0_2 != null) {
                    n2 = n5 == 2 ? var0_2[1].b() : var0_2[1].b() * 1000 + var0_2[2].b();
                    n3 = n7;
                    if (n6 == n2) {
                        if (n8 == 0) {
                            k.b((m)object3);
        ...
        if (n4 > 0) {
            ...
            if (object3 != null) {
                for (n8 = 0; n8 < n4; ++n8) {
                    ...
                    n6 = afArray[1].b();
                    n2 = n6 / 10 % 1000;
                    m m2 = ay.a(n3, al.d(n6 / 10000 % 100));
                    if (m2 == null && n2 != 39) continue;
                    n3 = 0;
                    if (afArray.length > 2) {
                        n3 = afArray[2].b();
                    }
                    if (n5 != 3 && n5 != 1 && n5 != 2 && n2 != 39 || !k.a(n6 % 10, (int)object2, n3, (m)object3, m2, n9, n2)) continue;
                    if (d) break;
                    d = true;
                    if (k.a(n2, n3)) break;
                    ((m)object3).a((int)(bc.a((int)object2) / 1000L), (int)var2_22, (m)object3, null, 0);
                    break;
                }
                if (!d && a == null) {
                    d = true;
            ...
            while (var5_15 < n4) {
                int n10;
                afArray = (af[])vector.elementAt((int)var5_15);
                n8 = afArray[0].b();
                m m3 = ay.a(n8, al.d((n10 = afArray[1].b()) / 10000 % 100));
                if (m3 != null) {
                    void var3_19;
                    n3 = 0;
                    n6 = 0;
                    ...
                    k.a((m)object3, m3, c, (int)var3_19, (int)var2_22, n10, n3, n8, n2);
                }
                ++var5_15;
            }
        }
        if ((n7 & 1) != 0 && ((m)object3).a() != null && !((bl)object3).a(((m)object3).a(), false)) {
            k.a((short)2, (m)object3, ((m)object3).a());
            k.a((m)object3);
        }
        k.a(ay.a);
    }
    ...
    private static boolean a(int var0, int var1_1, int var2_2, m var3_3, m var4_4, int var5_5, int var6_6) {
        block13: {
            block14: {
                ...
                var1_1 = var2_2 / 1000;
                var0 = var2_2 % 1000;
                if (var3_3.q == var1_1 && var3_3.r == var0) break block14;
                var10_8 = var11_10 = k.a(var3_3, var1_1, var0, 20, 5, 39);
...
lbl21:
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            var13_13 /* !! */  = null;
                                                                                            if (var7_7 > 0) {
                                                                                                var13_13 /* !! */  = bg.a(var7_7 * 10000, var10_12 / 10000 % 1000);
                                                                                            }
                                                                                            var8_14 = (byte)(var6_6 / 1000 % 100);
                                                                                            var0 = new Object[]{new an(var5_5), new bf(5931010, var10_12 / 100 % 100 % 8), new an(var4_4), new an(var9_8), new an(1), new an(var2_2), new j(var15_9), var13_13 /* !! */ , new t(var8_14)};
...
lbl19:
                            ...
                            while (true) {
                                k.a(var5_9, var0, null, var2_2[1].b(), var2_2[2].b(), var3_6, var4_5);
lbl21:
                                // 3 sources
...
lbl57:
                                ...
                                while (true) {
                                    ...
                                    if (!aa.a().a((int)var0.d, var9_11 * var6_10 + var4_5, var9_11 * var5_9 + var3_6)) ** GOTO lbl86
                    ...
                    var4_5 = (short)(var4_5 + (var9_11 - 1) * var6_10);
                    var5_9 = (short)(var3_6 + var5_9 * (var9_11 - 1));
                    var3_6 = var4_5;
                    var4_5 = var5_9;
                    ** continue;
lbl86:
                    ...
                    var7_8 = var4_5;
                    if (var9_11 == var10_4) {
                        var7_8 = (short)(var4_5 + var9_11 * var6_10);
                        var8_7 = (short)(var3_6 + var9_11 * var5_9);
                    }
                    ++var9_11;
                    var3_6 = var8_7;
                    var4_5 = var7_8;
    ...
    public static boolean a(m object, af[] object2, boolean bl2) {
        ...
        if (!bl3) return false;
        object = s.b[71];
        String string = s.b[70];
        String string2 = s.b[72];
        k.a(new StringBuffer().append((new String[]{object, string, string2})[n2]).append(s.d[72]).toString());
        return false;
    }
