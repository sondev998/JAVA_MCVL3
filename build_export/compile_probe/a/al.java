...
public class al {
    ...
    public static int a(Graphics graphics, Vector object) {
        ...
        block10: {
            ...
            block9: {
                ...
                if (a != 0) {
                    ...
                    reference var2_8;
                    object = aa.a();
                    reference var3_13 = ((aa)object).h / aa.c * 2;
                    reference var4_17 = ((aa)object).i / aa.d * 2;
                    int n5 = a.getWidth() - 48;
                    int n6 = a.getHeight() - 39;
                    if (var3_13 <= n5) {
                        var2_8 = var3_13;
                    }
                    reference var3_14 = var4_17;
                    if (var4_17 > n6) {
                        n4 = n6;
                    }
                    graphics.setClip(5, 14, 48, 39);
                    graphics.drawImage(a, 5 - var2_8, 14 - n4, 0);
                    Enumeration enumeration = m.a.elements();
                    while (enumeration.hasMoreElements()) {
                        object = (af[])enumeration.nextElement();
                        int n7 = ((af)object[1]).b() + 5 - var2_8;
                        n6 = ((af)object[2]).b() + 14 - n4;
                        if (n7 < 5 || n7 > 53 || n6 < 14 || n6 > 53) continue;
                        al.b(graphics, ((af)object[0]).b(), n7, n6);
                    }
                }
                break block10;
            }
            ...
            while (var2_6 >= 0) {
                ...
                int n8 = afArray[1].b() + 5 - 2;
                int n9 = afArray[2].b() + 14 - 2;
                if (n8 >= 5 && n8 <= 53 && n9 >= 14 && n9 <= 53) {
                    al.b(graphics, afArray[3].b(), n8, n9);
                }
                --var2_6;
            }
        }
        ...
        int n10 = s.a.stringWidth((String)object);
        if ((f -= 2) < 5 - n10) {
            f = 53;
        }
        ...
        ap.b.a(graphics);
        graphics.translate(-graphics.getTranslateX(), -graphics.getTranslateY());
        int n11 = al.a(graphics, 57, ac.a - 57, 90);
        return (int)var2_3;
    }
...
lbl51:
    ...
    public static void b(Graphics graphics, int n2, int n3, int n4, int n5) {
        n3 = n3 + n5 - b;
        int n6 = n3 + (b - s.h + a) / 2;
        n5 = (c - s.a.stringWidth(s.a[1])) / 2;
        al.d(graphics, n2, n3, c, b, false);
        al.d(graphics, n2 + n4 - c, n3, n6, b, false);
        graphics.setColor(0xFFFFFF);
        graphics.drawString(s.a[6], n2 + n5, n3 + (b - s.h + a) / 2, 0);
        graphics.drawString(s.a[1], n2 + n4 - c + n5, n6, 0);
    }
